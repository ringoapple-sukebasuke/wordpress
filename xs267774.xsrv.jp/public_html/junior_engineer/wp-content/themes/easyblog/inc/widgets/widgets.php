...
class easyblog_social_icons extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
            ...
            __( 'Easyblog: Social Icons', 'easyblog' ),
            array(
    ...
    public function widget( $args, $instance ) {
        ...
        <div class="dt-social-icons">
            <?php if( ! empty( $title ) ) { ?><h2 class="widget-title"><?php echo esc_html( $title ); ?></h2><?php } ?>
...
class easyblog_ads extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
            'easyblog_ads',
            __( 'Easyblog: Banner Advertisement ', 'easyblog' ),
            array(
...
class easyblog_recent_posts extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
            ...
            __( 'Easyblog: Recent Posts', 'easyblog' ),
            array(
            ...
            if ( $query->have_posts() ) :
                while ( $query->have_posts() ) : $query->the_post(); ?>
                    ...
                    <div class="dt-recent-post">
                        ...
                        <h3><a href="<?php esc_url( the_permalink() ); ?>" title="<?php the_title_attribute(); ?>"><?php echo esc_html( the_title() ); ?></a></h3>
                    </div>
